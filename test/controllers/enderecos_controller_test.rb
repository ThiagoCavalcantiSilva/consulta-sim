...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { CEP: @endereco.CEP, bairro: @endereco.bairro, cidade: @endereco.cidade, complemento: @endereco.complemento, logradouro: @endereco.logradouro, paciente_id: @endereco.paciente_id } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { CEP: @endereco.CEP, bairro: @endereco.bairro, cidade: @endereco.cidade, complemento: @endereco.complemento, logradouro: @endereco.logradouro, paciente_id: @endereco.paciente_id } }
